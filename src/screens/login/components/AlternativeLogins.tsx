  ...
  return (
    <>
      {connections?.map((connection: SocialConnection) => {
        ...
        // Custom Google icon with colors
        const customIconComponent = connection.name === 'google-oauth2' ? (
        ...
        return (
          <ULThemeSocialProviderButton
            ...
            className="h-10 text-sm font-medium border-gray-300 text-gray-700 hover:bg-gray-50 w-full"
          />
        );
      })}
    </>
